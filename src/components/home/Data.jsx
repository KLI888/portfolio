...
import hiiImage from '../../assets/hii.png' // Adjust the path accordingly
import Typewriter from 'typewriter-effect';

function Data() {
    return (
        <div className="home__data">
            <h1 className="home__title">Krishna Borse
            <img src={hiiImage} className="home__hand" alt="" />
            {/* <svg
                width="36"
                height="36"
                viewBox="0 0 48 48"
            ...
            </svg> */} {/* Either use image or the svg of hand */}
            </h1>
            <h3 className="home__subtitle">
                <Typewriter
                    options={{
                        strings: ['Visual Designer' ,'AI/ML Engineer' ,'Security Researcher'],
                        autoStart: true,
                        loop: true,
                    }}
                />
            ...
            <p className="home__description">
                I'm creative designer based in Jalgaon MH, and I'm very passionate and dedicated to my work. 📍    
            </p>
